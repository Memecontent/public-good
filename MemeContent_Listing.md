...
- **Creator Incentives:** Earn MEMCOT for uploading popular templates.  
- **Governance:** Vote on features, UI updates, and meme categories.  
- **Discounts & Partnerships:** Receive discounts on advertising integrations and partner services.

---

## 2. Token Name and Ticker
- **Token Name:** MemeContent  
- **Ticker:** MEMCOT
...
## 5. Monthly Team Budget — $50,000

| Category                             | Monthly Budget (USD) |
|--------------------------------------|----------------------|
| Development / Backend, Frontend, AI  | $25,000              |
| Creative / Motion Design             | $10,000              |
| Marketing / Growth                   | $10,000              |
| Infrastructure / Cloud / Tools       | $5,000               |
